...
e<d.length;e++){var a=d[e];var g=typeof(d[e-1])!="undefined"?d[e-1]:a;var k=typeof(d[e+1])!="undefined"?d[e+1]:a;if(this.options.lineCurve&&c<3){this.options.lineCurve=false;}if(!this.options.lineCurve){this.context.lineTo(a.x,a.y);}else{if(e==(d.length-1)){break;}if(e==0){this.context.moveTo(a.x,a.y);
